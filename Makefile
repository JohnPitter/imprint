.PHONY: dev build hooks mcp cli codex-watch frontend test clean all
...
# Build everything
all: frontend build hooks mcp cli codex-watch
...
clean:
	rm -rf imprint.exe build/hooks build/mcp-server.exe build/codex-watch.exe
	rm -rf frontend/dist
