...
if [ ! -x "$PLUGIN_ROOT/bin/mcp-server" ] || [ ! -x "$PLUGIN_ROOT/bin/ensure-server" ] || [ ! -x "$PLUGIN_ROOT/bin/imprint" ] || [ ! -x "$PLUGIN_ROOT/bin/codex-watch" ] || [ ! -x "$PLUGIN_ROOT/bin/codex-hook" ]; then
